...
/* ------------------------------------------------------------------------------------------------
 * ADC REG1 配置（数据速率、模式、转换模式、温度、烧断电流）
 * ------------------------------------------------------------------------------------------------ */
// Data Rate Settings
...
/* ------------------------------------------------------------------------------------------------
 * ADC REG2 配置（参考源、FIR滤波、电源开关、IDAC）
 * ------------------------------------------------------------------------------------------------ */
// Reference Settings
...
/**
 * @brief 设置ADS1120片选信号
 * @param level 片选电平（0/1）
 */
void ADS1120_SetCS(uint8_t level);

/**
 * @brief 设置ADS1120时钟信号
 * @param level 时钟电平（0/1）
 */
void ADS1120_SetCLK(uint8_t level);

/**
 * @brief 设置ADS1120 MOSI信号
 * @param level MOSI电平（0/1）
 */
void ADS1120_SetMOSI(uint8_t level);

/**
 * @brief 读取ADS1120 MISO信号
 * @return MISO电平（0/1）
 */
uint8_t ADS1120_GetMISO(void);

/**
 * @brief 设置ADS1120 DRDY信号
 * @param level DRDY电平（0/1）
 */
void ADS1120_SetDRDY(uint8_t level);

/**
 * @brief 读取ADS1120 DRDY信号
 * @return DRDY电平（0/1）
 */
...
/**
 * @brief ADS1120 GPIO初始化
 */
void ADS1120_Gpio_Init(void);

/**
 * @brief 设置ADS1120转换完成标志
 * @param flag 标志值
 */
